...
router.get('/', function (req, res) {
  res.render('index', { title: 'railway App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'railway App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Railway App Login', user: req.user });
});
